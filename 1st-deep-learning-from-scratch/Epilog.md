...
근 몇년간 머신러닝과 딥러닝의 인기와 더불어 관련된 책들도 많이 출간 되었습니다. 하지만 책들의 난이도가 천차만별이라 입문자가 적합한 책을 고르기는 쉽지 않습니다. 이 책은 딥러닝 공부를 막 시작하는 사람들에게 아주 좋은 책입니다.

 이 책에 대해 하나 먼저 알아두셔야 할 점은 머신러닝에 대해서 자세히 다루지는 않습니다. 즉, regression, classification, clustering 등에 대해서는 자세히 다루지 않습니다. 대신 perceptron과 neural network를 비롯한 딥러닝의 기초 이론과 딥러닝에서 활용되는  최근 기술(책 출판기준)들을 소개합니다. 즉, 딥러닝 전반을 훑기에 아주 적당한 책으로 볼 수 있습니다.

 파이썬을 잘 모르더라도 전체적인 흐름을 이해하는데는 문제없지만 코드의 의미를 정확히 이해하려면 파이썬을 알아두시면 좋습니다. 특히 이 책은 딥러닝의 기초에 해당하는 이론들을 쉬운 파이썬 코드로 꽤 구체적으로 작성했기 때문에 한줄 한줄 코드의 의미를 정확히 이해하시기를 권유드립니다.

 지금도 딥러닝과 관련된 기술과 알고리즘들이 매일매일 새롭게 발표되고 있습니다. 쏟아지는 기술속에 마음이 급해질 수 있지만 이 책을 꼼꼼히 학습해서 기초지식을 잘 이해하신다면 앞으로 새로운 내용을 공부하는데에 큰 도움이 되실 것이라 생각합니다.
